...
class MomentumTradingRecomposer:
    ...
    async def weighting(self):
        # addresses = ['terra1g4x2pzmkc9z3mseewxf758rllg08z3797xly0n']
        ...
        data = [await mirror_history_query(a, minutes, from_time, to) for a in addresses]
        ...
        name_to_addr = {name: addrs for name, addrs in zip(asset_names, self.asset_addresses)}
        target_assets = [name_to_addr[b_a] for b_a in best_assets]

        return target_assets, target_weights, asset_names
